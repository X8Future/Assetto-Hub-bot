...
# Disclaimer
### Code is made and tested in Future Crew servers™. Code is written by an AMATEUR and should be treated as such, some parts may not make sense, be redundant, or just not work (whitelist command). USE AT YOUR OWN RISK. Updates may come in the future to fix issues. 
