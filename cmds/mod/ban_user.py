...
ENDPOINTS = [
    {"host": "5.78.113.173", "username": "root", "password": "", "remote_path": "/root/Spec/blacklist.txt"},
]
# Endpoints u want to send the blacklist.txt (Should only need to be the hub) 
# Edit the endpoint above to be yours
