...
class BayAreaForumPostUpdater(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.forum_channel_id = 1288021868971819028
        self.api_url = "http://5.78.115.40:8083/info"

        self.image_links = {i: f"https://futurecrew.sirv.com/images/Bay_area/{i}.png" for i in range(26)}
...
async def setup(bot):
    cog = BayAreaForumPostUpdater(bot)
