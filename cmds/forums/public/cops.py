...
class CopsForumPostUpdater(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.forum_channel_id = 1268666206810931210
        
        self.api_urls = [
            "http://5.78.93.251:8085/INFO",
            "http://5.78.75.101:8081/INFO",
            "http://91.99.6.152:80811/INFO"
        ]
...
async def setup(bot):
    await bot.add_cog(CopsForumPostUpdater(bot))
