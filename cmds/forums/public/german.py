...
class GermanForumPostUpdater(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.forum_channel_id = 1268666206810931210
        self.api_url = "http://5.78.75.101:8080/info"

        self.image_links = {i: f"https://futurecrew.sirv.com/images/german/{i}.png" for i in range(63)}
...
async def setup(bot):
    cog = GermanForumPostUpdater(bot)
