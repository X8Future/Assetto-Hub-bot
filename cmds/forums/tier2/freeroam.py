...
class FreeroamForumPostUpdater(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.forum_channel_id = 1288021928862420992
        self.api_url = "http://5.78.129.133:8080/INFO"
        self.image_links = {
...
async def setup(bot):
    cog = FreeroamForumPostUpdater(bot)
